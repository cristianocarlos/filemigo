...
import type {TZustandArrayUseStore, TZustandCommonUseStore, TZustandObjectUseStore} from '@/utils/zustand/types';
...
export function useCommonDispatchArrayAddItemAtBeginning<G>(
  ...
  keyPath: null | string | TArrayKey | undefined,
) {
...
export function useCommonInitValue(useStore: TZustandCommonUseStore, keyPath: null | string | TArrayKey | undefined) {
